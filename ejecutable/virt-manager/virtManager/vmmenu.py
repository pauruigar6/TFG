...
class VMActionMenu(_VMMenu):
    ...
    def _init_state(self):
        ...
        # ——— Inserción del nuevo ítem “Convertir en plantilla” ———
        self._add_action(_("Convertir en plantilla"), "convert-template", VMActionUI.convert_to_template)
        # ———————————————————————————————————————————————
...
class VMActionUI(object):
    ...
    @staticmethod
    def convert_to_template(src, vm):
        from .template_utils import convert_vm_to_template_dialog
        convert_vm_to_template_dialog(src, vm)